...
class GAVariant(object):
    ...
    def __init__(self, id, variantSetId, start, end, referenceBases, names=[], created=None, updated=None, referenceName='', alternateBases=[], info={}, calls=[]):
        ...
        self.gavariant_info = {'id': id, 'variantSetId': variantSetId, 'names': names, 'created': created, 'updated': updated, 'referenceName': referenceName,
                               'start': start, 'end': end, 'referenceBases': referenceBases, 'alternateBases': alternateBases, 'info': info, 'calls': calls}
