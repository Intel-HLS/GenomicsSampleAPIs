...
def initConfig(conf_file):
    ...
    LoadedConfig.SQLALCHEMY_DATABASE_URI = configParser.get('tiledb', 'SQLALCHEMY_DATABASE_URI')

    LoadedConfig.SEARCHLIB = configParser.get('auto_configuration', 'SEARCHLIB')
    ...
    LoadedConfig.SITE_PACKAGES = configParser.get('virtualenv', 'SITE_PACKAGES')
