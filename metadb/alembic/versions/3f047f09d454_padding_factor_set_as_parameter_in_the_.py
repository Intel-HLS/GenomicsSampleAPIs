...
def upgrade():
    ...
    op.add_column('reference_set', sa.Column('tiledb_reference_offset_padding_factor', sa.Float(53), server_default=sa.text(u'1.10'), nullable=False))
...
def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    #Downgrade trigger by dropping the trigger and downgrading the trigger function
    op.execute('DROP TRIGGER IF EXISTS increment_next_column_in_reference_set ON reference CASCADE');
    ...
    op.add_column('reference_set', sa.Column('offset_factor', sa.Float(53), autoincrement=False, nullable=True))
